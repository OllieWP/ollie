...
<!-- wp:navigation {"overlayMenu":"always","openSubmenusOnClick":true,"icon":"menu","layout":{"type":"flex","orientation":"vertical"},"style":{"spacing":{"blockGap":"var:preset|spacing|small"},"layout":{"selfStretch":"fit","flexSize":null}},"fontSize":"small"} /--></div>
<!-- /wp:group --></header>
<!-- /wp:group -->
