...
<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/ollie-laptop.webp","id":2763,"hasParallax":true,"dimRatio":0,"overlayColor":"main","isUserOverlayColor":true,"minHeight":40,"minHeightUnit":"vw","contentPosition":"bottom center","isDark":false,"align":"wide","className":"is-style-blur-image is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"bottom":"var:preset|spacing|large","top":"var:preset|spacing|large","right":"var:preset|spacing|large","left":"var:preset|spacing|large"}},"color":{"duotone":"var:preset|duotone|blue"},"border":{"radius":"5px"}}} -->
<div class="wp-block-cover alignwide is-light has-parallax has-custom-content-position is-position-bottom-center is-style-blur-image is-style-default" style="border-radius:5px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large);min-height:40vw"><span aria-hidden="true" class="wp-block-cover__background has-main-background-color has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__image-background wp-image-2763 has-parallax" style="background-position:50% 50%;background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/ollie-laptop.webp)"></div><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"wide","className":"is-style-default","style":{"spacing":{"blockGap":"var:preset|spacing|medium"},"border":{"radius":{"topLeft":"5px","topRight":"5px"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
