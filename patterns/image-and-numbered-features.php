...
<!-- wp:group {"metadata":{"name":"Image and Numbered Features"},"align":"full","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large","right":"var:preset|spacing|medium","left":"var:preset|spacing|medium"}}},"layout":{"inherit":true,"type":"constrained"}} -->
	...
	<!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|x-large","left":"var:preset|spacing|x-large"},"margin":{"top":"0px","bottom":"0px"}}}} -->
		...
		<!-- wp:column {"verticalAlignment":"center"} -->
			...
			<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/computer-hands.webp","id":43,"dimRatio":0,"minHeightUnit":"px","isDark":false,"style":{"dimensions":{"aspectRatio":"1"},"border":{"radius":"5px"}}} -->
		...
		<!-- wp:column {"verticalAlignment":"center"} -->
			...
			<!-- wp:group {"metadata":{"name":"Feature"},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
				<div class="wp-block-group">
				<!-- wp:group {"style":{"spacing":{"padding":{"top":"5px","bottom":"5px","left":"13px","right":"14px"}},"border":{"radius":"100px"}},"backgroundColor":"primary","layout":{"type":"constrained"}} -->
					<div class="wp-block-group has-primary-background-color has-background" style="border-radius:100px;padding-top:5px;padding-right:14px;padding-bottom:5px;padding-left:13px">
					<!-- wp:paragraph {"textColor":"base"} -->
			...
			<!-- wp:group {"metadata":{"name":"Feature"},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
				<div class="wp-block-group">
				<!-- wp:group {"style":{"spacing":{"padding":{"top":"5px","bottom":"5px","left":"14px","right":"13px"}},"border":{"radius":"100px"}},"backgroundColor":"primary","layout":{"type":"constrained"}} -->
					<div class="wp-block-group has-primary-background-color has-background" style="border-radius:100px;padding-top:5px;padding-right:13px;padding-bottom:5px;padding-left:14px">
					<!-- wp:paragraph {"textColor":"base"} -->
