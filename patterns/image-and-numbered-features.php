...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/computer-hands.webp","id":43,"dimRatio":0,"minHeightUnit":"px","isDark":false,"style":{"color":{"duotone":["#462CFF","#ECE8FF"]},"dimensions":{"aspectRatio":"1"},"border":{"radius":"5px"}}} -->
