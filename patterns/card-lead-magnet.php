...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/ollie-laptop.webp","id":2763,"dimRatio":0,"customOverlayColor":"#b8b4b6","minHeight":281,"minHeightUnit":"px","isDark":false,"className":"is-style-rounded-cover","style":{"color":{"duotone":["#462CFF","#ECE8FF"]}}} -->
<div class="wp-block-cover is-light is-style-rounded-cover" style="min-height:281px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#b8b4b6"></span><img class="wp-block-cover__image-background wp-image-2763" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/ollie-laptop.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
