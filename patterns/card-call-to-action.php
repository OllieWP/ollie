...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__('Download Ollie', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color"><?php echo esc_html__('Version 1.0', 'ollie'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-base-color has-text-color"><?php echo esc_html__('Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Ollie block theme. No coding skills required. Anyone can do it!', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"is-style-button-light"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-button-light"><a class="wp-block-button__link wp-element-button" href="https://olliewp.com"><?php echo esc_html__('Download Now', 'ollie'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size"><a href="#"><?php echo esc_html__('or view on WordPress.org', 'ollie'); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
